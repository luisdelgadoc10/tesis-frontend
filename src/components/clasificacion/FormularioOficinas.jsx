...
/**
 * Formulario para establecimientos del tipo "Oficinas".
 * 
 * Contiene pasos con campos relacionados a:
 * - Infraestructura del edificio
 * - Área y conformidad
 * - Antigüedad y vigencia
 * - Tipo de conformidad y ocupación
 * - Áreas comunes y ubicación
 * - Diseño y remodelaciones
 */
export default function FormularioOficinas({ datos, onChange }) {
  const pasos = [
    // 🏢 Paso 1: Infraestructura del Edificio
    {
    ...
    // 📐 Paso 2: Área Total y Conformidad
    {
    ...
    // ⏳ Paso 3: Antigüedad y Vigencia de Conformidad
    {
    ...
    // 🧾 Paso 4: Tipo de Conformidad y Ocupación
    {
    ...
    // 🏙️ Paso 5: Áreas Comunes y Ubicación
    {
    ...
    // 🧱 Paso 6: Diseño y Remodelaciones
    {
